...
if($_SESSION['type'] == 2)
{
    ...
    if($type != -1)
    {
        echo "This user has no blacklist";
    }
    else{
        if (isset($_POST['unblacklistbtn'])) {
            $id = $_POST['unblacklist'];
            $conn = dbConnect();
            ...
            $json_data = json_encode([
                ...
                "embeds" => [
                    [
                        ...
                        "title" => "New Unblacklist",
                        "type" => "rich",
                        "description" => "A new user has been Unblacklisted on agb999.xyz",
                        "timestamp" => $timestamp,
                        "color" => hexdec( "FF0000" ),
                        "footer" => [
                            "text" => "AGB999",
                        ...
                        "fields" => [
                            ...
                            [
                                "name" => $username . " Has been Unblacklisted!",
                                "value" => "User unblacklisted: " . '**'.$username.'**' . "\n" . "Unblacklisted by: " . '**'.$_SESSION['username'].'**',
                                "inline" => false
                            ],
                        ]
                    ]
